...
static int on_mod_morph_binding_pressed(struct zmk_behavior_binding *binding,
	...
	if (zmk_hid_get_explicit_mods() & cfg->mods) {
		LOG_DBG("zmk_hid_get_explicit_mods() & cfg->mods resolved to true, passing morph_binding");
		...
		LOG_DBG("zmk_hid_get_explicit_mods() & cfg->mods did not resolve to true, passing normal_binding");
